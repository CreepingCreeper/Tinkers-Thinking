...
public interface ModifierUtils {
    ...
    static void addEffect(LivingEntity living, MobEffect effect, int duration, int amplifier) {
        addEffect(living, effect, duration, amplifier, true);
    }
    static void addEffect(LivingEntity living, MobEffect effect, int duration, int amplifier,boolean visible) {
    ...
    static void particles(Level level, LivingEntity living, ParticleOptions particleType, int count){
        for (int i = 0 ; i<count ; i++){
            particles(level, living, particleType);
        }
    }
    static void heal(LivingEntity living, float amount){
        living.heal(amount);
    ...
    static void block(LivingEntity living){
