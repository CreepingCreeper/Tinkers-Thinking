...
public class ModBook extends BookData {
    ...
    public static void initBook() {
        ...
        FANTASTIC_GADGETRY.addTransformer(ToolTagInjectorTransformer.INSTANCE);
        FANTASTIC_GADGETRY.addTransformer(ModifierTagInjectorTransformer.INSTANCE);
        ToolSectionTransformer armorTransformer = new ToolSectionTransformer("armor");
        FANTASTIC_GADGETRY.addTransformer(armorTransformer);
