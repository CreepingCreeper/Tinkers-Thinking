...
public class BurningOutModifier extends Modifier implements MeleeDamageModifierHook, ProjectileHitModifierHook {
    ...
    @Override
    public ProjectileImpactEvent.ImpactResult onProjectileHitEntity(@NotNull ModifierNBT modifiers, ModDataNBT persistentData, @NotNull ModifierEntry modifier, @NotNull Projectile projectile, EntityHitResult hit, @javax.annotation.Nullable LivingEntity attacker, @javax.annotation.Nullable LivingEntity target) {
        int fire = 0;
