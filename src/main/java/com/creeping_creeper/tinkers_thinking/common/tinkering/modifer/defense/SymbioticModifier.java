...
public class SymbioticModifier extends Modifier implements  MeleeHitModifierHook, ProjectileLaunchModifierHook, ModifyDamageModifierHook{
    ...
    @Override
    public void onProjectileLaunch(@NotNull IToolStackView tool, @NotNull ModifierEntry modifier, LivingEntity entity, @NotNull Projectile projectile, @Nullable AbstractArrow arrow, ModDataNBT persistentData, boolean primary) {
        float level = modifier.getEffectiveLevel();
