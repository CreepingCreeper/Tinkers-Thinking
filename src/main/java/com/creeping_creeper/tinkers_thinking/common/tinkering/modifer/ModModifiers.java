...
public class ModModifiers extends ModModule {
    ...
    public static final StaticModifier<Modifier> Density = MODIFIERS.register("density",Modifier::new);
    ...
    public static final StaticModifier<Modifier> RepeatingBoost = MODIFIERS.register("repeating_boost", Modifier::new);
