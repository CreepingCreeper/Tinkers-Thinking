...
public record BideTimeModule(int cooldown) implements ModifierModule, ProjectileShootModifierHook {
    ...
    static {
        ...
        LOADER = RecordLoadable.create(IntLoadable.FROM_ZERO.requiredField("cooldown", BideTimeModule::cooldown), BideTimeModule::new);
    }

    public RecordLoadable<BideTimeModule> getLoader() {
        return LOADER;
    }
    ...
    public void onProjectileShoot(IToolStackView tool, ModifierEntry modifier, @Nullable LivingEntity shooter, ItemStack ammo, Projectile projectile, @Nullable AbstractArrow arrow, ModDataNBT persistentData, boolean primary) {
        if (shooter instanceof Player player) {
            ...
            player.getCooldowns().addCooldown(player.getOffhandItem().getItem(), cooldown);
        }
    }
}
