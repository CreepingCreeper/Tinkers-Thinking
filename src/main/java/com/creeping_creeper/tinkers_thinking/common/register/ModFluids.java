...
public class ModFluids extends ModModule{
    ...
    public static final FlowingFluidObject<ForgeFlowingFluid> molten_echo  = FLUIDS.registerGem("molten_echo").type(common("molten_echo").temperature(250).lightLevel(3)).block(createEffect(MapColor.COLOR_BLACK,3, () -> new MobEffectInstance(MobEffects.DARKNESS, 100))).bucket().flowing();
    ...
    public static final FlowingFluidObject<ForgeFlowingFluid> color_liquid  = FLUIDS.registerSlime("color_liquid").type(common("color_liquid").temperature(250).lightLevel(15)).block(createEffect(COLOR_YELLOW,15, () -> new MobEffectInstance(MobEffects.GLOWING, 160))).bucket().flowing();
    public static final FlowingFluidObject<ForgeFlowingFluid> error_liquid   = FLUIDS.registerSlime("error_liquid").type(common("error_liquid").temperature(250).lightLevel(7)).block(createEffect(COLOR_PURPLE,7, () -> new MobEffectInstance(MobEffects.BLINDNESS, 160))).bucket().flowing();

    public static final FlowingFluidObject<ForgeFlowingFluid> syrup  = FLUIDS.register("syrup").type(common("syrup").temperature(275).lightLevel(0)).block(createEffect(MapColor.COLOR_ORANGE,0, () -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 100))).bucket().flowing();
    public static final FlowingFluidObject<ForgeFlowingFluid> pulp  = FLUIDS.register("pulp").type(common("pulp").temperature(225).lightLevel(0)).block(createEffect(MapColor.COLOR_LIGHT_GRAY,0, () -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100))).bucket().flowing();
    ...
    public static final FlowingFluidObject<ForgeFlowingFluid> molten_cocoa  = FLUIDS.register("molten_cocoa").type(hot("molten_cocoa").temperature(350).lightLevel(7)).block(createEffect(MapColor.COLOR_ORANGE, 7,() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100))).bucket().flowing();
    public static final FlowingFluidObject<ForgeFlowingFluid> molten_black_chocolate  = FLUIDS.register("molten_black_chocolate").type(hot("molten_black_chocolate").temperature(360).lightLevel(7)).block(createEffect(MapColor.COLOR_BLACK,7, () -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 100))).bucket().flowing();
    public static final FlowingFluidObject<ForgeFlowingFluid> molten_white_chocolate  = FLUIDS.register("molten_white_chocolate").type(hot("molten_white_chocolate").temperature(350).lightLevel(7)).block(createEffect(MapColor.COLOR_LIGHT_GRAY,7, () -> new MobEffectInstance(MobEffects.DIG_SPEED, 100))).bucket().flowing();
